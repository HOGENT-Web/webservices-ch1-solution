...
const { checkFunctionReturn } = require('./check_helper');
...
function exercise3() {
	// this is where we'd use the map function, rewrite exercise2 using map
...
function exercise6() {
	...
	return courses.filter((obj) => obj.hours === 3).map((obj) => obj.teacher);
}
...
// while everything can be solved using elaborate forEach's too, that's not really the point
//
// (it's possible you have to write helper functions btw, or at least that parts of the solution to
// one exercise, can be reused for another)
...
function _exercise14(age) {
	...
	return impacts.filter(isImpactYoungerThan(1920)).map((obj) => obj.name);
}
...
cont =
	cont &&
	checkFunctionReturn(exercise2, [
		{ id: 1098, name: 'webapps' },
		{ id: 3872, name: 'android' },
		{ id: 7291, name: 'ios' },
		{ id: 981, name: 'windows' },
	]);
cont =
	cont &&
	checkFunctionReturn(exercise3, [
		{ id: 1098, name: 'webapps' },
		{ id: 3872, name: 'android' },
		{ id: 7291, name: 'ios' },
		{ id: 981, name: 'windows' },
...
cont =
	cont &&
	checkFunctionReturn(exercise4, [
		{ id: 1098, name: 'webapps', teacher: 'pieter', hours: 3 },
		{ id: 981, name: 'windows', teacher: 'joeri', hours: 3 },
	]);
cont =
	cont &&
	checkFunctionReturn(exercise5, [
		{ id: 1098, name: 'webapps', teacher: 'pieter', hours: 3 },
		{ id: 981, name: 'windows', teacher: 'joeri', hours: 3 },
	]);
...
cont =
	cont &&
	checkFunctionReturn(exercise12, [
		'Bulls Run',
		'Clohars',
		'Jalanash',
		'Jemlapur',
...
cont =
	cont &&
	checkFunctionReturn(exercise13, [
		'Alfianello',
		'Allende',
		'Bjurböle',
		'Boguslavka',
...
cont =
	cont &&
	checkFunctionReturn(exercise14, [
		'Aarhus',
		'Abee',
		'Acapulco',
		'Adzhi-Bogdo (stone)',
...
cont =
	cont &&
	checkFunctionReturn(exercise15, {
		1946: 4,
		1947: 6,
		1948: 3,
		1949: 12,
